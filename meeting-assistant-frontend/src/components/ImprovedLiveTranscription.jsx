    ...
    try {
      ...
      websocket.onmessage = (event) => {
        try {
          ...
          } else if (data.type === 'final' || data.type === 'interim') {
            const newTranscript = data.text;
            
            // Log interim results for debugging
            if (data.type === 'interim') {
              console.log('Interim:', newTranscript);
            }
            
            setTranscript(current => {
              // For final results, append to the existing transcript
              if (data.type === 'final' && newTranscript.trim()) {
                console.log('Final:', newTranscript);
